...
Engine.prototype.runNow = function(model, settings) {
            ...
            async.eachSeries(settings.urls, function(url, callback){
                ...
                if (!url.active) {
                    ...
                    phantomas(fixedUrl, phantomSettings, function(err, result) {
                            ...
                            model.Result.build({date: JSON.stringify(date), url: url.url, testResult: JSON.stringify(result), screen: phantomSettings.screenshot}).save();
